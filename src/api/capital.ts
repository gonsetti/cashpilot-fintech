...
function seedGraph(): CapitalGraph {
    ...
    const hq: Entity = { id: 'HQ', name: 'Alpha Holdings Group', liquidity: 5000000, monthlyBurn: 150000, revenue: 0, debt: 10000000, equity: 25000000, volatility: 0.05, riskScore: 12 };
    const subAlpha: Entity = { id: 'SUB_A', name: 'Alpha Logistics Tech', liquidity: 800000, monthlyBurn: 600000, revenue: 450000, debt: 2000000, equity: 500000, volatility: 0.25, riskScore: 40 };
    const subBeta: Entity = { id: 'SUB_B', name: 'Alpha FinServices', liquidity: 2000000, monthlyBurn: 300000, revenue: 800000, debt: 500000, equity: 6000000, volatility: 0.15, riskScore: 25 };
    const subGamma: Entity = { id: 'SUB_C', name: 'Gamma Experimental Ventures', liquidity: 150000, monthlyBurn: 120000, revenue: 10000, debt: 400000, equity: -100000, volatility: 0.60, riskScore: 85 };
