      ...
      <div className="min-h-screen bg-background flex items-center justify-center px-4">
        <div className="w-full max-w-sm text-center">
          ...
          <p className="text-muted-foreground text-sm mb-6">
            Enviamos un enlace de confirmación a <strong className="text-foreground">{email}</strong>. Haz clic en el enlace para activar tu cuenta.
          </p>
  ...
  return (
    <div className="min-h-screen bg-background flex items-center justify-center px-4">
      <div className="w-full max-w-sm">
        ...
        <h1 className="text-2xl font-bold text-foreground mb-2 text-center">Crea tu cuenta</h1>
        <p className="text-muted-foreground text-sm mb-8 text-center">Empieza a controlar tu flujo de caja</p>
